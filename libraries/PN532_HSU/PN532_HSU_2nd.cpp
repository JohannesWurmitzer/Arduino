...
PN532_HSU_2nd::PN532_HSU_2nd(HardwareSerial &serial)
{
    _serial = &serial;
    command = 0;
}

void PN532_HSU_2nd::begin()
{
    _serial->begin(115200);
}

void PN532_HSU_2nd::wakeup()
{
    _serial->write(0x55);
    _serial->write(0x55);
    _serial->write(0);
...
int8_t PN532_HSU_2nd::writeCommand(const uint8_t *header, uint8_t hlen, const uint8_t *body, uint8_t blen)
{
...
int16_t PN532_HSU_2nd::readResponse(uint8_t buf[], uint8_t len, uint16_t timeout)
{
    uint8_t tmp[3];
...
int8_t PN532_HSU_2nd::readAckFrame()
{
...
*/
int8_t PN532_HSU_2nd::receive(uint8_t *buf, int len, uint16_t timeout)
{
  int read_bytes = 0;
  int ret;
