...
#define TASK6_INTERVAL      1000       // [ms] interval for task6 (time distance from call to next call)
#define TASK7_INTERVAL      500        // [ms] interval for task7 (time distance from call to next call)
#define TASK8_INTERVAL      1000       // [ms] interval for task8 (time distance from call to next call)
