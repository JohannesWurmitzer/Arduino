...
#define DI_SW_LO_1  8
#define DI_SW_LO_2  9
#define DI_SW_LO_3  10

#define DI_SW_HI_1  11
#define DI_SW_HI_2  12
#define DI_SW_HI_3  13
...
void setup() {
  ...
  Serial.println("Setup Villinger Safran Heating Seat Mockup");
...
//  digitalWrite(LED_BUILTIN, HIGH);
  delay(500);
  Serial.println("Status Area 1: ");
  Serial.print(digitalRead(DI_SW_ON_1)); Serial.print(" "); Serial.print(digitalRead(DI_SW_LO_1)); Serial.print(" ");  Serial.print(digitalRead(DI_SW_HI_1)); Serial.print(" "); Serial.println();
  Serial.print(digitalRead(DI_SW_ON_2)); Serial.print(" "); Serial.print(digitalRead(DI_SW_LO_2)); Serial.print(" ");  Serial.print(digitalRead(DI_SW_HI_2)); Serial.print(" "); Serial.println();
  Serial.print(digitalRead(DI_SW_ON_3)); Serial.print(" "); Serial.print(digitalRead(DI_SW_LO_3)); Serial.print(" ");  Serial.print(digitalRead(DI_SW_HI_3)); Serial.print(" "); Serial.println();
  Serial.println();
